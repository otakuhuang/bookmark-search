...
- **语义搜索**: 使用多语言 Sentence Transformer 模型，理解中文语义
- **本地运行**: 所有 AI 模型在本地执行，保护隐私
- **快速响应**: HNSW 索引加速相似度搜索
- **断点续传**: 支持中断后继续处理
...
- **AI 模型**: @xenova/transformers (paraphrase-multilingual-MiniLM-L12-v2)
...
2. **向量生成**: 自动遍历所有书签，使用 AI 模型生成向量嵌入
